...
# VVD v3 Pipeline
#
# v3 uses the stricter wallet provisioning definition from the SAS
# "Success01" logic: adds MRCHNT_NM = 'Visa Provisioning Serv' and
# APPROVAL_CODE IS NOT NULL filters to the EDW wallet query.
...
download_csv(mega_output, "vvd_v3_mega_output.csv")
...
download_csv(fqm_output, "vvd_v3_mega_output_lite.csv")
